...
await conn.send3ButtonImg(m.chat, `${global.putra}`, putra, amelia, 'Aʟʟ Mᴇɴᴜ', '.m15 all', 'Lɪsᴛ Mᴇɴᴜ', '.m15', '\n️Owner️', '.owner', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
