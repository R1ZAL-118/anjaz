 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	title: `┄┄┄┄┅┅| SUPPORT |┅┅┄┄┄┄`,
	rows: [
	    {title: `🔖 ${pmenus} Sewa Bot`, rowId: ".sewabot", description: "Menampilkan list harga sewa BOT"},
	...
	title: `┄┄┄┄┅┅| MENU |┅┅┄┄┄┄`,
	rows: [
	    {title: `💬☜ ${pmenus} All`, rowId: ".menu6 all", description: "Menampilkan Semua command BOT"},
	    {title: `🌱☜ ${pmenus} Rpg`, rowId: ".menu6 rpg", description: "Game Epic Rpg!"},
	{title: `✨☜ ${pmenus} Exp`, rowId: ".menu6 xp", description: "Ayo tingkatkan pangkat mu!"},
	{title: `🎮☜ ${pmenus} Game`, rowId: ".menu6 game", description: "Gamenya seru seru lho >-<"},
	{title: `🧩☜ ${pmenus} Fun`, rowId: ".menu6 fun", description: "Fitur yang aman untuk keluarga"},
	{title: `🐚☜ ${pmenus} Kerang`, rowId: ".menu6 kerangajaib", description: "Tanyakan pada ketua club"},
	{title: `📑☜ ${pmenus} Quotes`, rowId: ".menu6 quotes", description: "Random Inspirasi"},
	{title: `⛩️☜ ${pmenus} Anime`, rowId: ".menu6 anime", description: "Kamu wibu ya bang?"},
	{title: `🔞☜ ${pmenus} Nsfw`, rowId: ".menu6 nsfw", description: "Tch, dasar sagne"},
	{title: `🌟☜ ${pmenus} Premium`, rowId: ".menu6 premium", description: "Only premium Users"},
	{title: `🎭☜ ${pmenus} Anonymous Chats`, rowId: ".menu6 anonymous", description: "Bicara dengan orang tidak dikenal"},
	{title: `📖☜ ${pmenus} Al-Quran`, rowId: ".menu6 quran", description: "Tobat yuk kak"},
	{title: `🌐☜ ${pmenus} Internet`, rowId: ".menu6 internet", description: "Cari sesuatu diBOT"},
	{title: `📩☜ ${pmenus} Downloaders`, rowId: ".? downloader", description: "Download sesuatu diBOT"},
	{title: `🎨☜ ${pmenus} Stikers`, rowId: ".menu6 stiker", description: "Buat Sticker diBOT"},
	{title: `✏️☜ ${pmenus} Nulis`, rowId: ".menu6 nulis", description: "Nulis kok males kak?"},
	{title: `🎧☜ ${pmenus} Audio`, rowId: ".menu6 audio", description: "Ubah Audio dengan Filter"},
	{title: `🏢☜ ${pmenus} Group`, rowId: ".menu6 group", description: "Only Groups"},
	{title: `👑☜ ${pmenus} Admin`, rowId: ".menu6 admin", description: "Only Admin Group"},
	{title: `🗂☜️ ${pmenus} Database`, rowId: ".menu6 database", description: "Simpan sesuatu diBOT"},
	{title: `🛠️☜ ${pmenus} Tools`, rowId: ".menu6 tools", description: "Mungkin tools ini bisa membantu?"},
	{title: `ℹ️️☜ ${pmenus} Info`, rowId: ".menu6 info", description: "Info info BOT"},
	{title: `👩‍💻☜ ${pmenus} Owner`, rowId: ".menu6 owner", description: "Owner Only!"},
	{title: `🖼️ ${pmenus} Maker`, rowId: ".menu6 maker", description: "Fitur Maker menu"},
