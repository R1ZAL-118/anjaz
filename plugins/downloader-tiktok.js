...
`
 conn.sendButton(m.chat, cap, author, cer.video.watermark, [["🎥 Video [NO WM]", usedPrefix + "get " + cer.video.noWatermark], ["🎶 Music", usedPrefix + "get " + cer.music.play_url]], m, ftroli)
 } catch (e) {
 if (!text) throw "\nSertakan querinya kak !\n\nContoh: .tiktok url"
    m.reply(wait)
...
handler.help = ["ttkcaliphdev2"]
handler.command = /^(ttkcaliphdev2)$/i
