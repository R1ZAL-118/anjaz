...
if (command == 'creator') {
 let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:WhatsApp; RizalzBot\nNICKNAME:👑 Owner QuaetzBot\nORG: RizalzBot\nTITLE:soft\nitem1.TEL;waid=6285768097041:+62 857-6809-7041\nitem1.X-ABLabel:📞 Nomor Owner\nitem2.URL:https://s.id/Cerdasin62\nitem2.X-ABLabel:💬 More\nitem3.EMAIL;type=INTERNET: kelaza89@gmail.com\nitem3.X-ABLabel:💌 Mail Owner QuartzBot\nitem4.ADR:;;🇮🇩 Indonesia;;;;\nitem4.X-ABADR:💬 More\nitem4.X-ABLabel:📍 Lokasi Saya\nBDAY;value=date:🔖 ,18 January 2006\nEND:VCARD`
const tag_own = await conn.sendMessage(m.chat, { contacts: { displayName: wm, contacts: [{ vcard }] }}, { quoted: fkontak })
let caption = `👋 Hai *@${who.split("@")[0]}*, Nih Owner Saya kak`
    await conn.sendButton(m.chat, caption, author, null, [['Menu', '.tesm']], m, { quoted: fkontak, mentions: conn.parseMention(caption) })
}
if (command == 'own') {
